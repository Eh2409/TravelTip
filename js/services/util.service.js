...
function getColors(selector) {
    switch (selector) {
        case 'loc-stats-rate':
            return ['#F44336', '#FFEBEE', '#EF9A9A', '#E57373', '#EF5350', '#F44336', '#E53935', '#D32F2F', '#C62828']
        case 'loc-stats-last-updated':
            return ['#0d3ef2', '#00bbff', '#e9fffd', '#0d3ef2', '#00bbff', '#e9fffd']
    }
}
